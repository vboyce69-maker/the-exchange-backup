    ...
    try {
      ...
      if (action === "dismiss") {
        ...
        toast({
          ...
          description: "The report has been cleared from the queue.",
        });
      } else {
        await updateDoc(ref, {
          status: action === "resolve" ? "resolved" : "blocked",
        });
        toast({
          title: `Record ${action}d`,
          description: "The moderation status has been updated.",
        });
      }
    } catch (err) {
      toast({
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="space-y-1">
              ...
              <p className="text-muted-foreground font-black text-[10px] uppercase tracking-widest flex items-center gap-2">
                <ShieldAlert className="w-3 h-3 text-red-500" /> Human Review
                Queue (Falcon Engine)
              </p>
            </div>
            <Badge
            ...
            {isLoading ? (
                  ...
                  <div className="p-8 flex flex-col lg:flex-row gap-8">
                    <div className="flex-1 space-y-4">
                      ...
                      <div className="flex items-center gap-6">
                        ...
                        <Button
                          variant="link"
                          className="h-auto p-0 font-black text-[#225BC3] text-[10px] uppercase tracking-widest"
                        >
              ...
              <div className="text-center py-32 bg-white rounded-[4rem] shadow-sm border-2 border-dashed border-slate-100">
                ...
                <p className="text-muted-foreground text-sm font-medium">
                  No pending moderation tasks detected.
                </p>
              </div>
            )}
          </div>
