                  ...
                  <div className="space-y-1 pr-2">
                    {menuItems.map((item, idx) => (
                      <DropdownMenuItem
                        key={idx}
                        asChild
                        className="rounded-2xl p-3 cursor-pointer hover:bg-slate-50 transition-all group"
                      >
                        <Link
                          href={item.href}
                        ...
                        >
                          ...
                          <div>
                            <p className="font-black text-xs uppercase tracking-tight text-slate-900 leading-none mb-1.5">
                              {item.title}
                            </p>
            ...
            {user ? (
              <DropdownMenu>
                ...
                >
                  ...
                  <DropdownMenuItem
                    asChild
                    className="rounded-xl p-3 font-bold uppercase text-[9px] tracking-widest gap-3"
                  >
                  ...
                  <DropdownMenuItem
                    ...
                    className="rounded-xl p-3 font-bold uppercase text-[9px] tracking-widest gap-3 text-red-500"
                  >
