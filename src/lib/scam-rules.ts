...
export const SCAM_RULES: ScamRule[] = [
  ...
  },
  {
    ...
    explanation:
      "High-urgency language and requests for deposits before viewing are common scam indicators.",
  },
  {
    id: "external_payment",
    ...
    explanation:
      "Direct payment requests bypass our Protected Hold. Never pay outside the app.",
  },
  {
    id: "courier_scam",
    ...
    explanation:
      "Potential courier scam detected. Always meet at Safe Zones for physical item trades.",
  },
];
...
export function detectScam(
  ...
  if (userTrustScore < 30) {
    ...
    reasons.push(
      "Risk flag: Interaction with a low-trust or unverified account.",
    );
  }
